  ...
  <>
    ...
    <Styled.SectionWrapper>
      ...
      <Styled.SectionParagraph>
        ...
        <ul>
           <li>For metrics aggregated at a monthly level, choose or create a record for the month and year for which you want to enter data. 
</li>
           <li>For metrics aggregated at an annual level, choose or create a record for the year, ensuring the correct standard is chosen. Calendar Year spans from January 1st to December 31th of the specified year while Fiscal Year spans from July 1st to June 30th of the following year. 
</li>
        </ul>
