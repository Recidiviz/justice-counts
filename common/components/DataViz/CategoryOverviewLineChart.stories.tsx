...
import { CategoryOverviewLineChart } from "./CategoryOverviewLineChart";

const meta: Meta<typeof CategoryOverviewLineChart> = {
  title: "CategoryOverviewLineChart",
  component: CategoryOverviewLineChart,
  tags: ["autodocs"],
  parameters: {
    layout: "centered",
    backgrounds: {
...
export default meta;
type Story = StoryObj<typeof CategoryOverviewLineChart>;
...
export const Default: Story = {
  args: {
    ...
    dimensions: ["Sentenced", "Transfer or Hold", "Pretrial", "Unknown"],
  },
};
